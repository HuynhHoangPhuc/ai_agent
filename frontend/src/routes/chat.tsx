...
function ChatPage(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Chat Container */}
        <div className="w-full p-4 h-[calc(100vh-80px)] flex flex-col">
          {/* Messages Area */}
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="text-sm">
                        <Markdown>{msg.text || "Chatbot is thinking"}</Markdown>
                      </div>
                      <p
...
function UploadFile() {
  ...
  return (
    <div className="w-[40vw] p-4 h-[calc(100vh-80px)] flex flex-col">
      <div className="flex-1 bg-white rounded-lg shadow-sm border border-gray-200 mb-4 flex flex-col overflow-y-auto">
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
